#!/usr/bin/env python3
# make_bkg_hists.py  (m_hhh_vis-binned, NN-cut)
import os
import argparse
...
TREE_NAME        = "events"
VAR_NAME_DEFAULT = "mlp_score"       # histogram variable (now m_hhh_vis)
EDGES_DEFAULT    = "0.6,0.7,0.8,0.9,1"      # two bins by default
NN_BRANCH_DEF    = "mlp_score"
NN_CUT_DEF       = 0.6
WEIGHT_BRANCH    = "weight_xsec"     # per-event weight (σ × k-factors / sumW)

# Sample -> filename mapping (one file per sample under IN_DIR)
BKG_SAMPLES = {
    "hh": "pwp8_pp_hh_k3_1_k4_1_84TeV.root",
    "tth" : "mgp8_pp_tth01j_5f_84TeV.root",
    "vbf_h": "mgp8_pp_vbf_h01j_5f_84TeV.root",
    "jjaa" : "mgp8_pp_jjaa_5f_84TeV.root",
    "h": "mgp8_pp_h012j_5f_84TeV.root"
}
