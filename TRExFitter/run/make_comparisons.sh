...
python 2D_scenarios.py --stat /data/atlas/users/dingleyt/FCChh/trex/TRExFitter/Thesis_k3k4_stat/LHoodPlots/NLLscan_k3_k4_histo.root \
    ...
    --xmin -0.75 --xmax 4.5 --ymin -8 --ymax 25 --out Theeeesis_k3k4_comparisons.pdf \
    --labels "HHH" "HH" "Combination" --comp
    
# with k4
python make_LH_scenarios.py --labels "HHH" "HH" "Combination" --out Theeeesis_k4_comparisons.pdf  \
...
# now with k3
python make_LH_scenarios_k3.py --labels "HHH" "HH" "Combination" --out Theeeesis_k3_comparisons.pdf  \
...
python 2D_scenarios.py --stat /data/atlas/users/dingleyt/FCChh/trex/TRExFitter/Thesis_k3k4_scenI/LHoodPlots/NLLscan_k3_k4_histo.root \
    ...
    --xmin -0.75 --xmax 4.5 --ymin -8 --ymax 25 --out Theeeesis_k3k4_comparisons_scenI.pdf \
    --labels "HHH" "HH" "Combination" --comp
    
# with k4
python make_LH_scenarios.py --labels "HHH" "HH" "Combination" --out Theeeesis_k4_comparisons_scenI.pdf  \
...
# now with k3
python make_LH_scenarios_k3.py --labels "HHH" "HH" "Combination" --out Theeeesis_k3_comparisons_scenI.pdf  \
