...
The purpose of this directory is to provide a reproducible chain from input ntuples to final calibration products that can be loaded by the MMC reconstruction code.
